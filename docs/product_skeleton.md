...
- Целевой визуальный язык — Grimdark Tactical Mono: плотный tactical UI,
  плоские 1px borders, минимальные скругления, mono-числа, янтарный акцент.
- Dark theme является дефолтом; light theme доступна на раннем этапе как
