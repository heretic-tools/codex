...
test("standalone Builder build cache-busts HTML and local module imports", () => {
  ...
  try {
    ...
    assert.match(index, new RegExp(`/builder/static/win-scrollbars\\.js\\?v=${version}`));
    ...
    assert.match(unitRowsSource, new RegExp(`\\.\\/builder_swipe_action\\.js\\?v=${version}`));
    ...
    assert.match(unitWargearSectionSource, new RegExp(`\\.\\/builder_roster_unit_wargear_validation_view\\.js\\?v=${version}`));
    ...
    assert.match(unitAllegianceEditorSource, new RegExp(`\\.\\/builder_roster_undoable_update\\.js\\?v=${version}`));
    ...
    assert.match(unitWarlordEditorValidationSource, new RegExp(`\\.\\/builder_roster_undoable_update\\.js\\?v=${version}`));
    ...
    assert.match(unitEnhancementEditorSource, new RegExp(`\\.\\/builder_roster_undoable_update\\.js\\?v=${version}`));
