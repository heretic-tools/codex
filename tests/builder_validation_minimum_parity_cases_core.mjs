export const minimumParityCoreCases = [
  {
    ...
    "anchors": [
      ...
      "static Builder data manifest lists every exported rule file without audit-only hashes",
      "static Builder audit keeps file integrity out of the runtime manifest",
      "precomputedEntries.length >= 1 || legacyPrecomputedEntryCount === 1",
      "tableEntries.length, exportedTableNames.length",
      "Object.keys(tableCounts).length > exportedTableNames.length",
      "integrity.sha256",
