...
function attachmentCatalog() {
  ...
  return {
    ...
    datasheetBodyguardGroupDatasheetsByGroupId: new Map([
      ["leader-bodyguard-group", [{ datasheetId: "bodyguard" }]],
      ["support-bodyguard-group", [{ datasheetId: "bodyguard" }]],
    ]),
...
test("builder roster action derives attachment summaries when omitted", () => {
  const catalog = {
    ...realCatalog,
